...
const PostJob = () => {
  ...
  // console.log("Companies from Redux store:", companies); // Debugging log
  const changeEventHandler = (e) => {
    setInput({...input, [e.target.name]: e.target.value})
  }

  const selectChangeHndler = (value) => {
    // console.log("Company ID selected:", value); // Debugging log
  ...
  return (
    <div>
      ...
      <div className='flex items-center justify-center w-screen my-5'>
        ...
        {
          companies.length > 0 && (
            <Select onValueChange={selectChangeHndler}>
              <SelectTrigger>
