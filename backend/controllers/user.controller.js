...
export const register = async (req, res) => {
  try {
    ...
    await User.create({
      // add those all which are required
...
export const updateProfile = async(req, res) => {
  try{
    ...
    const file = req.file;   
    // here cloudinary code will be added for resume upload
    ...
    if(cloudResponse){
      ...
      user.profile.resumeOriginalName = file.originalname;  //save the original file name of resume
    }
